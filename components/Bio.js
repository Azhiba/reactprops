...
import React, {Component} from 'react'
    ...
    return (
        <div className="media">
            ...
            <span style= {myStyle}>Bio:</span>{this.props.FullName} is {this.props.Age} years old, I like {this.props.Interests}<br/>
            {/* <span style= {myStyle}>Profession:</span>{this.props.Profession}  */}
